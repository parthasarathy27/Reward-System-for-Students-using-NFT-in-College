...
if "templates" not in __name__:
    ...
    sp.add_compilation_target("Token", FA2(
        config = FA2_config(
            non_fungible= True,
        ...
        metadata = sp.big_map({
            ...
            "content": sp.utils.bytes_of_string("""{"name": "NCU Achievemnets NFTs" , "description : Verified Acievements of NCU" , "version" : "FA2" , "author" : "pichkari&gamma" , "homepage" : "https://ncucoin.netlify.app/" , "interfaces" : "https://gitlab.com/tezos/tzip/-/tree/master/proposals/tzip-16" }"""),
        })
    ))