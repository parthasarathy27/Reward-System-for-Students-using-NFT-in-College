...
class NCUCoinCrowdsale(sp.Contract):
    def __init__(self,_admin,_tokenAddress):   
        self.init(
            ...
            "content": sp.utils.bytes_of_string("""{"name": "NcuCoin Distributor" , "description : Distributor contract for NCUCoin to disburse tokens to students" , "admin" : "tz1NaGu7EisUCyfJpB16ktNxgSqpuMo8aSEk" , "author" : "pichkari&gamma" , "homepage" : "https://ncucoin.netlify.app/"}"""),
        })
...
def test():
    ...
    sp.add_compilation_target("CoinDistributor", NCUCoinCrowdsale(
        _admin = sp.address("tz1NaGu7EisUCyfJpB16ktNxgSqpuMo8aSEk"),
